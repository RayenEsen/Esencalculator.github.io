    ...
    {
        var res;
        res=Number(document.BC1SEMESTER1.result1.value*1)+Number(document.BC1SEMESTER1.result2.value*1.5)+Number(document.BC1SEMESTER1.result3.value*1)+Number(document.BC1SEMESTER1.result4.value*1)+Number(document.BC1SEMESTER1.result5.value*2)+Number(document.BC1SEMESTER1.result6.value*1)+Number(document.BC1SEMESTER1.result7.value*1.5)+Number(document.BC1SEMESTER1.result8.value*1)+Number(document.BC1SEMESTER1.result9.value*1)+Number(document.BC1SEMESTER1.result10.value*1.5)+Number(document.BC1SEMESTER1.result11.value*1)+Number(document.BC1SEMESTER1.result12.value*1.5);       
